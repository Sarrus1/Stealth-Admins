...
{
	name = "Simple Stealth",
	author = "Potatoz, Sarrus",
	description = "A plugin that allows admin to switch to spectators and be undetected by other players.",
	version = "1.1",
	url = "https://github.com/Sarrus1?tab=repositories"
}
...
public OnPluginStart()
{
	...
	RegAdminCmd("sm_stealth", Command_StealthMode, ADMFLAG_GENERIC);
